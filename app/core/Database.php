...
class Database
{
    private $driver = DB_DRIVER; // PDO driver (mysql or pgsql)
    ...
    {
        // Build DSN from selected driver.
        if ($this->driver === 'pgsql') {
            $dsn = 'pgsql:host=' . $this->host . ';dbname=' . $this->dbname . ';port=' . $this->dbport;
        } else {
            $dsn = 'mysql:host=' . $this->host . ';dbname=' . $this->dbname . ';port=' . $this->dbport . ';charset=utf8mb4';
        }
